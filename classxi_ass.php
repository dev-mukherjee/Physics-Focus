			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto text-white">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#"="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Assignments
						</a>
						<div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
							<a class="dropdown-item bg-dark" id="current_page" href="#">Class XI</a>
							<a class="dropdown-item bg-dark" href="classxii_ass.php">Class XII</a>
						</div>
					</li>
					<li class="nav-item ">
        ...
        <div class="container mt-5">
            ...
            <div class="container-body">
                <div class="table-responsive">
                    <table class="table tableable-striped" id="mytable">
                        <thead>
