      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu bg-dark text-white" aria-labelledby="navbarDropdown">
              <a class="dropdown-item text-white bg-dark active" href="studymaterialsXI.php">Class XI</a>
            ...
            <div class="card card-outline card-info">
              ...
              <div class="card-body pad">
                <div class="mb-3">
                  ...
                  <form action="studyassformXI.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="btn btn-success" name="submit" value="Class XI"/>
