  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu bg-dark text-white" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item text-white bg-dark active" href="#">Class XII</a>
            </div>
          </li>
        </ul>
      ...
      <!-- /.sidebar -->
                        ...
                        <div class="card card-outline card-info">
                            ...
                            <div class="card-body pad">
                                <div class="mb-3">
                                    ...
                                    <form action="studymatformXII.php" method="POST" enctype="multipart/form-data">

                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="InputFile" aria-describedby="inputGroupFileAddon01" name="fileinput">
                                            <label class="custom-file-label" id="custom-text" for="custom-text">Choose file</label>
                                        </div>

                                        <div class="buttons text-center pt-3">
                                            <h2 class="pb-2">Submit For</h2>

                                            <input type="submit" class="btn btn-success" name="submitxi" value="Class XII" />
        ...
        <div class="card">
            <div class="card-header">
                <h1 class="card-title text-center" id="headings">MATERIALS</h1>
            </div>
            <div class="card-body">
