        ...
        <div class="container text-uppercase pt-3">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto text-white">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="studymaterials.php" id="current_page">studymaterials</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item bg-dark" href="classxi_ass.php">Class XII</a>
                        </div>
                    </li>
                    <li class="nav-item ">
    ...
    <section class="container mt-5">
        <div class="container mt-5">
            ...
            <div class="container-header">
                <h1 class="card-title text-center pt-5 mt-5" id="headings">STUDY MATERIALS</h1>
            ...
            <div class="container-body">
                <div class="table-responsive">
                    <table class="table tableable-striped">
                        ...
                        $sql = "select * from study_classxii ";
